    ...
    <div className="min-h-screen bg-surface flex flex-col justify-center items-center p-4 md:p-8">
      <div className="w-full max-w-md bg-white rounded-[2rem] shadow-xl overflow-hidden flex flex-col">
        ...
        <div className="px-6 md:px-8 pb-8">
          ...
          <Button variant="outline" type="button" className="w-full flex items-center justify-center gap-3 border-surface-container rounded-xl h-14 hover:bg-surface-container-lowest transition-colors mb-6">
            ...
            <span className="font-bold text-on-surface text-base">Sign up with Google</span>
          </Button>
