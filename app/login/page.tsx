        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
          <div className="max-w-md w-full mx-auto">
            ...
            <form className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-bold text-on-surface uppercase tracking-wider">Password</label>
              ...
              <div className="flex items-center gap-3 pt-2">
                <input type="checkbox" id="keep-signed-in" className="w-5 h-5 rounded border-surface-container text-primary focus:ring-primary/40" />
                <label htmlFor="keep-signed-in" className="text-sm text-on-surface-variant">Keep me signed in for 30 days</label>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button type="button" className="flex items-center justify-center gap-2 border border-surface-container rounded-xl py-3 hover:bg-surface-container-lowest transition-colors">
