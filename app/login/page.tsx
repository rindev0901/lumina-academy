    ...
    <div className="min-h-screen bg-surface flex flex-col justify-center items-center p-4 md:p-8">
      <div className="w-full max-w-6xl bg-white rounded-[2rem] md:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[800px]">
        ...
        <div className="hidden md:flex md:w-1/2 bg-primary p-12 lg:p-16 flex-col justify-between relative overflow-hidden">
          {/* Background pattern */}
          <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-white to-transparent bg-[length:20px_20px]"></div>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <form className="space-y-5">
              ...
              <div className="flex items-center gap-3 pt-2">
                <Checkbox
                  id="keep-signed-in"
                  className="border-surface-container text-primary data-[state=checked]:bg-primary data-[state=checked]:text-white"
                />
                <Label
                  htmlFor="keep-signed-in"
                  className="text-sm font-normal text-on-surface-variant cursor-pointer"
                >
              ...
              <Button
                type="button"
                className="w-full bg-primary text-white font-bold h-14 rounded-xl hover:bg-primary/90 transition-colors mt-4 text-base"
              >
                Sign In
              </Button>
            </form>
